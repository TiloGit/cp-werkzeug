...
dnf install jq openssl wget zip unzip bind-utils -y \
dnf clean all \
curl --location  https://mirror.openshift.com/pub/openshift-v4/clients/ocp/stable-4.8/openshift-client-linux.tar.gz |   \
